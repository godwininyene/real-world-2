...
const Deposit = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6">
      ...
      <button
        onClick={() => navigate(-1)}
        className="flex cursor-pointer items-center gap-2 text-primary-light hover:text-primary mb-8 transition-colors"
      >
        ...
        <div className="flex items-center justify-between mb-2">
          {[1, 2, 3, 4].map((stepNumber) => (
            <div key={stepNumber} className="flex flex-col items-center">
              ...
              <div className={`text-xs mt-1 ${step >= stepNumber
        ...
        <div className="space-y-4">
          {paymentOptions && paymentOptions.length > 0 ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-text-light capitalize">
                      {option.payOption === 'bank'
                        ? 'Bank Transfer'
                        : option.payOption === 'mobile wallet'
                          ? 'Mobile Wallet'
                          : option.payOption === 'crypto wallet'
                            ? 'Crypto Wallet'
                            : option.payOption}
                    </h3>
                    <p className="text-sm text-gray-400">
            ...
            <div className="text-center text-gray-400">
              No payment methods available at the moment. Please check back later.
            </div>
          )}
        </div>
      )}
